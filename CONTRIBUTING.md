...
If you wish to contribute to eoko/zf-console, please be sure to
read to the following resources (we apply the same quality than ZF):

 -  [Coding Standards](https://github.com/zendframework/zf2/wiki/Coding-Standards)
 -  [Contributor's Guide](http://framework.zend.com/participate/contributor-guide)

If you are working on new features or refactoring [create a proposal](https://github.com/eoko/zf-console/issues/new).
...
- Clone the repository:
  ...
  ```console
  $ git clone git@github.com:eoko/zf-console.git
  $ cd
  ```
...
2. Fork the repository (http://github.com/eoko/zf-console)
